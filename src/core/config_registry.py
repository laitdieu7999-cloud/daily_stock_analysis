...
_CATEGORY_DEFINITIONS: List[Dict[str, Any]] = [
    ...
    },
    {
        "category": "strategy",
        "title": "Strategy",
        "description": "Strategy overlays and external tactical references.",
        "display_order": 57,
    },
    {
        "category": "schedule",
        "title": "Schedule",
        "description": "Timed tasks, reminders, and intraday collectors.",
        "display_order": 58,
    },
    {
        "category": "integration",
        "title": "Integration",
        "description": "External service credentials and local integration hooks.",
        "display_order": 59,
    },
    {
        "category": "backtest",
    ...
    },
    {
        "category": "advanced",
        "title": "Advanced",
        "description": "Experimental or expert-only settings.",
        "display_order": 70,
    },
    {
...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    "STOCK_LIST": {
        "title": "Holding / Main Analysis List",
        "description": "Comma-separated holding or main-analysis stock codes.",
        "category": "base",
        "data_type": "array",
        "ui_control": "textarea",
        "is_sensitive": False,
    ...
    "WATCHLIST_STOCK_LIST": {
        "title": "Separate Watchlist",
        "description": "Comma-separated watchlist codes. Scheduled reports analyze it together with STOCK_LIST; intraday reminders only alert buy signals for this list.",
        "category": "base",
        "data_type": "array",
        "ui_control": "textarea",
        "is_sensitive": False,
    ...
    "LLM_TEMPERATURE": {
        "title": "Temperature",
        "description": "Unified sampling temperature for all LLM calls. Range [0.0, 2.0], default 0.1.",
        "category": "ai_model",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "FEISHU_RATE_LIMIT_RETRY_SECONDS": {
        "title": "Feishu Rate-limit Retry Seconds",
        "description": "Seconds to wait before retrying once after Feishu returns code 11232 frequency limited.",
        "category": "notification",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "EXTERNAL_TACTICAL_REPORT_PATH": {
        "title": "External Tactical Report Path",
        "description": "Optional local Markdown/text file path(s), comma-separated, used as extra daily tactical references in the merged push.",
        "category": "strategy",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "reports/gemini_daily.md,reports/gemini_black_swan.md",
        "options": [],
        "validation": {},
        "display_order": 28,
    },
    ...
    "INTRADAY_SNAPSHOT_ENABLED": {
        "title": "Intraday Snapshot Collector",
        "description": "Enable lightweight periodic market snapshots for local intraday replay and review.",
        "category": "schedule",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "INTRADAY_SNAPSHOT_INTERVAL_MINUTES": {
        "title": "Intraday Snapshot Interval",
        "description": "Polling interval, in minutes, for local intraday snapshot collection.",
        "category": "schedule",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "STOCK_INTRADAY_REMINDER_ENABLED": {
        "title": "Stock Intraday Reminder",
        "description": "Enable repeated intraday reminders for actionable stock signals.",
        "category": "schedule",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "STOCK_INTRADAY_REMINDER_MAX_ITEMS": {
        "title": "Stock Reminder Max Items",
        "description": "Maximum number of intraday stock reminders in one push.",
        "category": "schedule",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "STOCK_INTRADAY_REMINDER_ANALYSIS_MAX_AGE_DAYS": {
        "title": "Stock Reminder Analysis Max Age",
        "description": "Only use analysis rows newer than this many days for intraday reminders.",
        "category": "schedule",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "STOCK_INTRADAY_SELF_CHECK_ENABLED": {
        "title": "Intraday Self-check",
        "description": "Send one short pre-open message confirming that intraday monitoring is alive.",
        "category": "schedule",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "STOCK_INTRADAY_SELF_CHECK_TIME": {
        "title": "Intraday Self-check Time",
        "description": "Pre-open self-check time, HH:MM.",
        "category": "schedule",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "STOCK_INTRADAY_REPLAY_LEDGER_ENABLED": {
        "title": "Intraday Replay Ledger",
        "description": "Record each new intraday trigger to a local JSONL ledger for later T+1/T+3 review.",
        "category": "schedule",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "STOCK_INTRADAY_HOLDING_COOLDOWN_MINUTES": {
        "title": "Holding Alert Cooldown",
        "description": "Cooldown minutes for the same holding-risk alert scope.",
        "category": "schedule",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "STOCK_INTRADAY_HOLDING_REALTIME_RADAR_ENABLED": {
        "title": "Holding Realtime Radar",
        "description": "Enable rule-based live holding risk checks beyond saved analysis signals.",
        "category": "schedule",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "STOCK_INTRADAY_HOLDING_INTRADAY_DROP_PCT": {
        "title": "Holding Intraday Drop Trigger",
        "description": "Trigger holding risk when intraday change is below this percent.",
        "category": "schedule",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "STOCK_INTRADAY_HOLDING_MA20_BREAK_BUFFER_PCT": {
        "title": "Holding MA20 Break Buffer",
        "description": "Buffer below saved MA20 before holding risk is triggered.",
        "category": "schedule",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "STOCK_INTRADAY_HOLDING_REVERSAL_FROM_HIGH_PCT": {
        "title": "Holding Reversal From High",
        "description": "Trigger holding risk after a live failure from intraday high by this percent.",
        "category": "schedule",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "STOCK_INTRADAY_HOLDING_TAIL_START_TIME": {
        "title": "Holding Tail Risk Start Time",
        "description": "Start time for tail-session MA5 holding risk checks, HH:MM.",
        "category": "schedule",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "STOCK_INTRADAY_WATCHLIST_DAILY_LIMIT": {
        "title": "Watchlist Daily Alert Limit",
        "description": "Maximum buy alerts per watchlist symbol per day.",
        "category": "schedule",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "STOCK_INTRADAY_SYSTEMIC_BATCH_THRESHOLD": {
        "title": "Systemic Batch Threshold",
        "description": "Merge holding-risk reminders into a systemic warning once this many positions trigger together.",
        "category": "schedule",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "STOCK_INTRADAY_BAD_TICK_MAX_ABS_CHANGE_PCT": {
        "title": "Bad Tick Max Abs Change",
        "description": "Isolate realtime quotes whose absolute intraday change exceeds this percent.",
        "category": "schedule",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "STOCK_INTRADAY_WATCHLIST_BUY_START_TIME": {
        "title": "Watchlist Buy Start Time",
        "description": "Earliest time to send watchlist buy alerts, HH:MM.",
        "category": "schedule",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "STOCK_INTRADAY_WATCHLIST_BUY_END_TIME": {
        "title": "Watchlist Buy End Time",
        "description": "Latest time to send watchlist buy alerts, HH:MM.",
        "category": "schedule",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "STOCK_INTRADAY_WATCHLIST_MIN_CHANGE_PCT": {
        "title": "Watchlist Min Intraday Change",
        "description": "Suppress watchlist buy alerts when the intraday change is weaker than this percent.",
        "category": "schedule",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "default_value": "-1.5",
        "options": [],
        "validation": {"min": -20, "max": 20},
        "display_order": 89,
    },
    "STOCK_INTRADAY_WATCHLIST_MAX_CHANGE_PCT": {
        "title": "Watchlist Max Intraday Change",
        "description": "Suppress watchlist buy alerts when the intraday change is hotter than this percent.",
        "category": "schedule",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "STOCK_INTRADAY_WATCHLIST_MAX_STOP_LOSS_DISTANCE_PCT": {
        "title": "Watchlist Max Stop Distance",
        "description": "Suppress watchlist buy alerts when the distance to stop loss is larger than this percent.",
        "category": "schedule",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "STOCK_INTRADAY_WATCHLIST_MA_PROXIMITY_PCT": {
        "title": "Watchlist MA Proximity",
        "description": "When saved MA5/MA20 exists, only alert if price is within this percent of either level.",
        "category": "schedule",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "STOCK_INTRADAY_WATCHLIST_REQUIRE_QUOTE": {
        "title": "Watchlist Requires Quote",
        "description": "Suppress watchlist buy alerts if realtime quote is unavailable.",
        "category": "schedule",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "STOCK_INTRADAY_WATCHLIST_REQUIRE_STOP_LOSS": {
        "title": "Watchlist Requires Stop Loss",
        "description": "Suppress watchlist buy alerts if the latest analysis has no explicit stop-loss price.",
        "category": "schedule",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "JIN10_API_KEY": {
        "title": "Jin10 API Key",
        "description": "API key for Jin10 flash/news/quote data used by the local market extension.",
        "category": "integration",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "JIN10_X_TOKEN": {
        "title": "Jin10 X-Token",
        "description": "Optional Jin10 web login x-token used for VIP watch endpoints such as watch events and indicator resonance.",
        "category": "integration",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "MARKET_DAILY_PUSH_ENABLED": {
        "title": "Market Daily Push",
        "description": "Enable the local gold/silver/CSI500 market summary before stock analysis.",
        "category": "schedule",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "MARKET_DAILY_PUSH_AI_ENABLED": {
        "title": "Market Push AI Summary",
        "description": "Attach an AI short commentary to the local market daily push.",
        "category": "schedule",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "CLOSE_REMINDER_ENABLED": {
        ...
        "description": "Enable the local post-close reminder task.",
        "category": "schedule",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "CLOSE_REMINDER_TIME": {
        "title": "Close Reminder Time",
        "description": "Daily execution time for the local close reminder task (HH:MM).",
        "category": "schedule",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "PREMARKET_HEALTH_CHECK_ENABLED": {
        "title": "Premarket Health Check",
        "description": "Enable the premarket system readiness self-check push.",
        "category": "schedule",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "PREMARKET_HEALTH_CHECK_TIME": {
        "title": "Premarket Health Check Time",
        "description": "Daily execution time for the system readiness self-check (HH:MM).",
        "category": "schedule",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "PREMARKET_HEALTH_CHECK_PUSH_OK": {
        "title": "Push Healthy Check Result",
        "description": "Push the premarket health check even when all systems are OK.",
        "category": "schedule",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "NIGHTLY_MARKET_OUTLOOK_ENABLED": {
        "title": "Nightly Market Outlook",
        "description": "Enable the local evening next-day market outlook task.",
        "category": "schedule",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "NIGHTLY_MARKET_OUTLOOK_TIME": {
        "title": "Nightly Market Outlook Time",
        "description": "Daily execution time for the next-day market outlook task (HH:MM).",
        "category": "schedule",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "NIGHTLY_MARKET_OUTLOOK_AI_ENABLED": {
        "title": "Nightly Market Outlook AI",
        "description": "Enable LLM commentary inside the evening next-day market outlook task.",
        "category": "schedule",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "NIGHTLY_MARKET_OUTLOOK_TIMEOUT_SECONDS": {
        "title": "Nightly Market Outlook Timeout",
        "description": "Maximum seconds allowed for evening market data collection before fallback report generation.",
        "category": "schedule",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "ENABLE_METAPHYSICAL_FEATURES": {
        "title": "Metaphysical Features",
        "description": "Enable experimental metaphysical/astro features for research or backtesting.",
        "category": "advanced",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "METAPHYSICAL_CACHE_DIR": {
        "title": "Metaphysical Cache Dir",
        "description": "Cache directory for experimental metaphysical/astro feature generation.",
        "category": "advanced",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "./data/metaphysical_cache",
        "options": [],
        "validation": {},
        "display_order": 78,
    },
...
def _infer_category(key: str) -> str:
    if key in {"STOCK_LIST", "WATCHLIST_STOCK_LIST"}:
        return "base"
...
def _infer_data_type(key: str, value_hint: Optional[str]) -> str:
    ...
    if key in {"STOCK_LIST", "WATCHLIST_STOCK_LIST", "EMAIL_RECEIVERS", "CUSTOM_WEBHOOK_URLS"}:
        return "array"
    return "string"
